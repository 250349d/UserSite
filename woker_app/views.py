...
def signup_view(request):
    if request.method == 'POST':
        ...
        form = SignUpForm()
    return render(request, 'woker_app_temp/signup.html', {'form': form})
...
def login_view(request):
    ...
    return render(request, 'woker_app_temp/login.html', {'form': form})
...
@login_required
def home(request):
    return render(request, 'woker_app_temp/home.html', {'user': request.user})
...
def create_request(request):
    if request.method == 'POST':
        ...
        if errors:
            return render(request, 'woker_app_temp/create_request.html', {
                'errors': errors,
...
def requester_home(request):
    ...
    return render(request, 'woker_app_temp/requester_home.html', {'tasks': tasks})
...
def receive_request(request):
    ...
    return render(request, 'woker_app_temp/receive_request.html', {'tasks': pending_tasks})
...
def confirm_request(request, pk):
    ...
    return render(request, 'woker_app_temp/confirm_request.html', context)
...
def submit_cost(request, pk):
    ...
    return render(request, 'woker_app_temp/submit_cost.html', {'task': task})
...
def cancel_request(request, pk):
    ...
    if request.method == 'POST':
        ...
        task.save()
        return redirect('requester_home')
    return render(request, 'woker_app_temp/cancel_request.html', {'task': task})
...
def approve_cost(request, pk):
    ...
    return render(request, 'woker_app_temp/approve_cost.html', {'task': task})
...
def accepted_requests(request):
    ...
    return render(request, 'woker_app_temp/accepted_requests.html', {'tasks': tasks})
...
def completed_requests_view(request):
    ...
    return render(request, 'woker_app_temp/completed_requests.html', {'tasks': completed_tasks})
...
def reward_check(request):
    ...
    return render(request, 'woker_app_temp/reward_check.html', context)