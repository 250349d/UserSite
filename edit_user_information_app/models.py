...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    first_name = models.CharField(verbose_name="名前", max_length=150, blank=True)
    last_name = models.CharField(verbose_name="名字", max_length=150, blank=True)
    birthdate = models.DateField(verbose_name="生年月日", null=True, blank=True)
    post_code = models.CharField(verbose_name="郵便番号", max_length=15, blank=True)
    address = models.CharField(verbose_name="住所", max_length=150, blank=True)
    street_address = models.CharField(verbose_name="番地以下", max_length=150, blank=True)
    ...
    telephone_number = models.CharField(verbose_name="電話番号", max_length=15, unique=True, blank=True, null=True)
